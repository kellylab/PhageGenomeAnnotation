...
@click.option('--blast_databasedir', help="where to find the blast databases", default='/nobackup1/jbrown/annotation/databases', show_defaults=True)
@click.option('--ublast_path', help="where ublast executable found", default='/home/sbiller/usearch7.0.1090_i86linux64', show_defaults=True)
@click.option('--ublast_evalue', help='evalue to use for ublast', default='1e-5', show_defaults=True)
@click.option('--path-to-crt', help='location of crt executable', default="/home/jbrown/programs/CRT1.2-CLI.jar", show_defaults=True)
...
@click.option("--nvp",
                ...
                default=True, show_defaults=True
                )
